...
git tag -a "v$build_version" -m "v$build_version" && git push git@github.com:adlawson/AeroSpace.git "v$build_version"
link="https://github.com/adlawson/AeroSpace/releases/new?tag=v$build_version"
...
./script/build-brew-cask.sh \
    --cask-name aerospace \
    --zip-uri "https://github.com/adlawson/AeroSpace/releases/download/v$build_version/AeroSpace-v$build_version.zip" \
